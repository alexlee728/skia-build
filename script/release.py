...
def main():
  ...
  try:
    ...
    resp = urllib.request.urlopen(urllib.request.Request('https://api.github.com/repos/alexlee728/skia-build/releases', data=data.encode('utf-8'), headers=headers)).read()
